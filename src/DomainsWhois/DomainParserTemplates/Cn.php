 ...
 */
//namespace Novutec\WhoisParser\Templates;
namespace Hwl\DomainsWhois\DomainParserTemplates;
...
class Cn extends Regex
{
    ...
    protected $blocks = array(
            ...
            8 => '/(Registration Date|Created On|Registration Time)(?>[\x20\t]*):(?>[\x20\t]*)(.*?)$/is',
    ...
    protected $blockItems = array(
            ...
            8 => array('/^Registration Time(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'created',
                    '/^Created On(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'created', 
                    '/^Expires On(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'expires', 
                    '/^Expiration Time(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'expires',
